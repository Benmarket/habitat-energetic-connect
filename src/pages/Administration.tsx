...
import { Loader2, FolderTree, Tags, Settings, Users, ArrowLeft, MessageCircle, Bot, FileCheck, FileText, Mail, Newspaper, BookOpen, HandCoins, Megaphone, Send, MessageSquare, Shield, Calculator, Smartphone, Layers, MousePointerClick, LayoutTemplate, BarChart3, UserCircle, Image, Star } from "lucide-react";
...
const Administration = () => {
  ...
  const sections = [
    ...
    { id: "landing-pages", label: "Pages & Contenu", icon: Layers, color: "bg-cyan-500" },
          ...
          <div className="container mx-auto px-4 py-6 md:py-8 lg:pl-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <Card className="group hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 border-l-4 border-l-orange-500 hover:scale-[1.02] hover:-translate-y-1">
                  <CardHeader>
                    ...
                    <CardTitle className="group-hover:text-orange-600 transition-colors">Confirmation (page merci + emails)</CardTitle>
                    <CardDescription>
                      Aperçu des templates email automatiques et page /merci
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <div id="landing-pages" className="mt-8 md:mt-12 animate-fade-in scroll-mt-24" style={{ animationDelay: '0.6s' }}>
              <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold">Pages & Contenu</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <Card className="group hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 border-l-4 border-l-cyan-500 hover:scale-[1.02] hover:-translate-y-1">
                  <CardHeader>
                    ...
                    <CardTitle className="group-hover:text-cyan-600 transition-colors">Médiathèque</CardTitle>
                    <CardDescription>
                      Visualisez et uploadez vos images, vidéos et fichiers hébergés
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Link to="/admin/mediatheque">
                      <Button className="w-full bg-gradient-to-r from-cyan-600 to-cyan-700 hover:from-cyan-700 hover:to-cyan-800 shadow-lg shadow-cyan-500/30">
                        Accéder
                      </Button>
                    </Link>
