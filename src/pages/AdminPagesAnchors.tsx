...
import { 
  ...
  MessageCircle, Calculator, FileCheck, Anchor, Link2
} from "lucide-react";
...
const SITE_PAGES = [
  ...
  { 
    id: "simulateur-solaire", 
    title: "Simulateur Solaire", 
    path: "/simulateur-solaire", 
    icon: Calculator, 
    color: "text-amber-600", 
    bgColor: "bg-amber-100",
    description: "Simulateur d'économies solaires",
    anchors: []
  },
];
...
const mockAnchorStats: Record<string, { clicks: number }> = {
  hero: { clicks: 2340 },
  simulateurs: { clicks: 1890 },
  aides: { clicks: 1456 },
  installateurs: { clicks: 3210 },
  "pourquoi-solaire": { clicks: 890 },
  actualites: { clicks: 670 },
  guides: { clicks: 540 },
  avis: { clicks: 780 },
};
...
const AdminPagesAnchors = () => {
  ...
  // Get all anchors from all pages
        ...
        <main className="container mx-auto px-4 py-8 mt-16">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Gérez vos landing pages, les pages du site et les ancres de navigation
            </p>
          </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <span>{tab.label}</span>
                  <Badge variant="secondary" className={`ml-1 ${isActive ? "bg-primary/10 text-primary" : ""}`}>
                    {tab.count}
                  </Badge>
                </button>
              );
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {landingPages.map((landing) => {
                  ...
                  const stats = mockLandingStats[landing.slug] || { views: 0, formSubmissions: 0, leads: 0, formStarts: 0 };
                    ...
                    >
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <code className="px-2 py-1 bg-muted rounded text-xs">{landing.path}</code>
                        </div>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="absolute top-3 right-3 p-2 rounded-lg bg-muted/80 hover:bg-primary hover:text-primary-foreground transition-colors z-10 opacity-0 group-hover:opacity-100"
                            >
                              <ExternalLink className="w-4 h-4" />
                            </a>
                          </TooltipTrigger>
                        ...
                        <div className="grid grid-cols-2 gap-2 pt-2 border-t">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold">{stats.views.toLocaleString()}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold">{stats.clicks.toLocaleString()}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        {page.anchors.length > 0 && (
                          <div className="flex items-center gap-2 pt-2 border-t">
                            ...
                            <span className="text-sm text-muted-foreground">
                              {page.anchors.length} ancre{page.anchors.length > 1 ? "s" : ""} disponible{page.anchors.length > 1 ? "s" : ""}
                            </span>
                          </div>
                        )}
                      </CardContent>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="p-4 bg-muted/50 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  Les ancres permettent de créer des liens directs vers des sections spécifiques de vos pages. 
                  Utilisez-les dans le header, footer ou dans vos contenus pour améliorer la navigation.
                </p>
              </div>
                  ...
                  return (
                    <Card key={anchor.id} className="hover:shadow-md transition-all">
                      <CardContent className="py-4 flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-lg ${anchor.pageBgColor} flex items-center justify-center flex-shrink-0`}>
                          <PageIcon className={`w-5 h-5 ${anchor.pageColor}`} />
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              className="h-6 px-2"
                              onClick={() => {
                                navigator.clipboard.writeText(anchor.path);
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-right">
                              ...
                              <p className="font-bold">{stats.clicks.toLocaleString()}</p>
                            </div>
                          </div>
          ...
          <DialogContent className="max-w-6xl h-[85vh]">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                Prévisualisation: {previewLanding?.title}
              </DialogTitle>
            </DialogHeader>
            <div className="flex-1 h-full min-h-0">
              {previewLanding && (
                <iframe
                  ...
                  title={`Prévisualisation de ${previewLanding.title}`}
                />
              )}
            </div>
          </DialogContent>
