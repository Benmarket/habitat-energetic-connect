...
const AppDownloadSection = () => {
  ...
  const handleInstallClick = async () => {
    if (deferredPromptRef.current) {
      ...
      // Instructions pour iOS ou déjà installé
      if (/iPhone|iPad|iPod/.test(navigator.userAgent)) {
        toast.info("Pour installer l'app sur iOS : touchez le bouton Partager, puis 'Sur l'écran d'accueil'");
      } else {
        toast.info("Application déjà installée ou installation disponible via le menu du navigateur");
      }
    }
  };
