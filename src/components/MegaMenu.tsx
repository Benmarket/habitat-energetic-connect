    ...
    categories: [
      {
        ...
        href: "/guides",
        items: [
          { label: "Guide énergie solaire", href: "/guide/adoptez-l-energie-solaire-guide-ultime-sur-les-panneaux-photovoltaiques-et-les-aides-gouvernementales" },
          { label: "Guide isolation", href: "/guide/maprimerenov-optimisez-l-isolation-de-votre-logement-facilement" },
          { label: "Guide pompe à chaleur", href: "/guide/pompe-a-chaleur-2025-choisir-et-installer" },
          { label: "Guide stockage énergie solaire", href: "/guide/solaire-batteries-autoconsommation-maximale" },
        ],
      },
    ],
  },
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className="space-x-1">
        ...
        {/* Aides - Direct link (no mega menu) */}
        {sectionVisibility.aides && (
          <NavigationMenuItem>
            <NavigationMenuLink asChild>
              <Link
                to="/aides"
                onClick={() => handleMenuClick('aides')}
                className="inline-flex items-center px-2 py-1.5 text-sm font-medium text-foreground hover:text-primary transition-colors"
              >
                Aides
              </Link>
