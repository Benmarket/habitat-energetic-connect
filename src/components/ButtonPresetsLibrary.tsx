...
const createDefaultButtons = async (userId: string) => {
  const defaultButtons = [
    ...
    { name: 'Or Luxe', description: 'Dégradé doré pour effet premium', text: 'Offre VIP', url: '#vip', background_color: '#f59e0b', text_color: '#000000', use_gradient: true, gradient_type: 'linear', gradient_color1: '#fbbf24', gradient_color2: '#f97316', gradient_angle: 90, hover_effect: true, hover_gradient_shift: false, border_width: 2, border_color: '#d97706', border_style: 'solid', border_radius: 8, padding_x: 30, padding_y: 15, size: 'large', width: 'auto', custom_width: 200, align: 'center', shadow_size: 'xl', is_favorite: false, favorite_order: null, user_id: userId },
