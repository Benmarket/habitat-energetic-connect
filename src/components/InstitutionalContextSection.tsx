...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      "Nous vous aidons à construire votre projet, et, si vous le souhaitez, un installateur de référence de votre région pourra vous être suggéré pour étudier votre demande. ",
