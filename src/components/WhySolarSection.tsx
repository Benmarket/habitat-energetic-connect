import { Leaf, Receipt, Gauge, Smartphone } from "lucide-react";
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center text-center">
                {/* Icon Circle */}
                <div className="w-32 h-32 lg:w-40 lg:h-40 rounded-full bg-muted flex items-center justify-center mb-6">
