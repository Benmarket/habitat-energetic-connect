...
const AidesSection = () => {
  ...
  const extractConditions = (content: string): string[] => {
    ...
    return conditions.length > 0
      ? conditions
      : ["Installation par un professionnel", "Logement de plus de 2 ans", "Équipements éligibles"];
  };
  ...
  return (
    <section id="aides" className="py-8 pb-4 md:py-12 md:pb-6 lg:py-20 lg:pb-10 bg-gradient-to-b from-blue-50/50 via-background to-background dark:from-blue-950/20 dark:via-background dark:to-background relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10 md:mb-14 animate-fade-in">
          <div className="inline-flex items-center gap-2 md:gap-3 mb-4 bg-gradient-to-r from-blue-600/10 to-blue-500/10 px-4 md:px-6 py-2 md:py-3 rounded-full backdrop-blur-sm border border-blue-500/20 shadow-lg shadow-blue-500/10">
            ...
            <h2 className="text-lg md:text-2xl lg:text-3xl font-extrabold bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 bg-clip-text text-transparent whitespace-nowrap">
              Aides et Subventions 2025-2026
            </h2>
          </div>
        ...
        {aides.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-lg text-muted-foreground mb-6">Aucune aide n'est disponible actuellement</p>
            {totalActiveAides > 0 && (
              <Link to="/aides">
          ...
          <>
            <div className="grid md:grid-cols-3 gap-6 mb-10 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              {aides.map((aide, index) => {
                ...
                return (
                  <Card
                    key={aide.id}
                    className="group hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 hover:scale-105 hover:-translate-y-1 h-full flex flex-col border-2 border-blue-500/20 hover:border-blue-500/40 overflow-hidden bg-card/80 backdrop-blur-sm min-h-[380px] max-h-[380px]"
                  >
                    ...
                    <CardContent className="flex-grow flex flex-col justify-between pt-2 pb-4">
                      <div>
                        <Badge
                          variant="secondary"
                          className="mb-2 text-xs px-3 py-1 bg-blue-500/10 text-blue-700 border-blue-500/20"
                        >
            ...
            <div
              className="mt-14 bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-950/30 dark:to-blue-900/20 rounded-3xl p-6 md:p-8 text-center border-2 border-blue-500/20 shadow-xl shadow-blue-500/10 backdrop-blur-sm animate-fade-in"
